...
REM timeout /t 2
del %OUTPUT_DIR%\com.zaphop.visualizer.streamDeckPlugin
%DISTRIBUTION_TOOL% -b -i bin\Debug\com.zaphop.visualizer.sdPlugin -o %OUTPUT_DIR%
rmdir %APPDATA%\Elgato\StreamDeck\Plugins\com.zaphop.visualizer.sdPlugin /s /q
START "" %STREAM_DECK_FILE%
timeout /t %STREAM_DECK_LOAD_TIMEOUT%
%OUTPUT_DIR%\com.zaphop.visualizer.streamDeckPlugin
